...
<div id='body-white'>
    ...
    <div class="form-container">
        ...
        <tr>
            ...
            <td><textarea name='issue_description' required="required" ><?php echo set_value('issue_description'); ?></textarea></td>
        </tr>
                    ...
                    <?php foreach( $type as $k => $v ) : ?>
                        <optgroup label="<?php echo $k ?>">
                            <?php foreach( $v as $stat ) : ?>
                                <?php
                                $select = '';
                                if ( set_value('issue_type') == $stat['id'] ) {
            ...
            <td>
                <select name='issue_severity' required="required" class="input-min-width">
                    ...
                    <?php foreach ($severity as $sev) : ?>
                            <?php
                            $select = '';
                            if ( set_value('issue_severity') == $sev['id'] ) {
                                $select = 'selected="selected"';
                            }
            ...
            <td>
                <select name="issue_owner" required="required" class="input-min-width">
                    ...
                    <?php foreach( $users as $user) : ?>
                        <?php
                        $select = '';
                        if ( set_value('issue_owner') == $user['id'] ) {
                            $select = 'selected="selected"';
                        }
